    ...
    <>
      ...
      ></div>
        <motion.div
          ...
          className="fixed top-1/2 left-1/2 z-20 rounded-md bg-white px-6 py-4 sm:px-12 sm:py-8 text-black mx-4 w-8/12 max-w-[20rem]"
        >
          Are you sure to delete?
          <div className="mt-8 flex justify-between gap-4 text-white">
            <Button onClick={handleDelete} style={{ backgroundColor: "#f00", fontSize: 15, padding: '4px 10px' }}>Delete</Button>
